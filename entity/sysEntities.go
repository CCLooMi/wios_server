...
type Menu struct {
	...
	Pid      *entity.ID `orm:"binary(16) comment '上级权限ID'" column:"pid"`
	Icon     string     `orm:"longtext comment '图标'" column:"icon"`
	Type     string     `orm:"varchar(16) comment '菜单类型'" column:"type"`
	RootId   *entity.ID `orm:"binary(16) comment '根菜单ID'" column:"rootId"`
...
type OrgUser struct {
	...
	OrgID  *entity.ID `orm:"binary(16) comment '组织ID'" column:"org_id"`
	entity.TimeEntity
}
...
type RoleMenu struct {
	entity.IdEntity
	RoleId *entity.ID `orm:"binary(16) comment '角色ID'" column:"role_id"`
	MenuId *entity.ID `orm:"binary(16) comment '视图ID'" column:"menu_id"`
	entity.TimeEntity
}
...
type RolePermission struct {
	entity.IdEntity
	RoleId       *entity.ID `orm:"binary(16) comment '角色ID'" column:"role_id"`
	PermissionId *entity.ID `orm:"binary(16) comment '权限ID'" column:"permission_id"`
	entity.TimeEntity
}
...
type Upload struct {
	...
	BizId    *entity.ID `orm:"binary(16) comment '业务ID'" column:"biz_id"`
...
type User struct {
	...
	Password *entity.ID `orm:"varbinary(32); not null comment '用户密码'" column:"password"`
	Seed     *entity.ID `orm:"binary(8); not null comment '密码种子'" column:"seed"`
	entity.TimeEntity
}
