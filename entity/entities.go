...
type Comment struct {
	...
	UserId   *entity.ID `orm:"type:binary(16); comment:'用户ID'" column:"user_id"`
	TargetId *entity.ID `orm:"type:binary(16); comment:'目标ID'" column:"target_id"`
	RootId   *entity.ID `orm:"type:binary(16); comment:'根ID'" column:"root_id"`
	entity.TimeEntity
}
...
type PurchasedWpp struct {
	entity.IdEntity
	UserId       *entity.ID `orm:"type:binary(16); comment:'用户ID'" column:"user_id"`
	WppId        *entity.ID `orm:"type:binary(16); comment:'应用ID'" column:"wpp_id"`
...
type Wpp struct {
	...
	DeveloperId *entity.ID `orm:"type:binary(16); comment:'开发者ID'" column:"developer_id"`
